...
冲突是**必然撞上的**，不依赖演示当天的运气：`RollingUserScheduleInitializer` 把「社区体检」固定排在**下周三 10:00–11:00**，而号源生成器在每位医生的**出诊日**都排了 **10:30**，周三一定有人出诊（01 号医生的出诊日就是周一/周三），两者必然重叠。该日程随今天滚动重排，所以演示话术「下周三去市第一医院心内科复诊」不管哪天演示都能造出冲突。
