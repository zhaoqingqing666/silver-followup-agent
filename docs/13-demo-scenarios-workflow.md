...
冲突是**必然撞上的**，不依赖演示当天的运气：`RollingUserScheduleInitializer` 把「社区体检」固定排在**下周三 10:00–11:00**，而号源生成器在科室的**放号日**都排了固定的 4 格（09:00 / 10:30 / 14:00 / 15:30）——`d001`（市第一医院·心内科）的放号日固定为**周一 / 周三 / 周五**，所以周三一定有号、且当天 10:30 那一格必然在，两者必然重叠。该日程随今天滚动重排，所以演示话术「下周三去市第一医院心内科复诊」不管哪天演示都能造出冲突。
