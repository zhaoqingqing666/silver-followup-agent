...
## 2026-09-15 业务时钟收成一份 `BusinessClock`；「这半天没号」说出真实理由（DEC-032）
...
## 2026-09-15 「这个时段约不上」在号源锁定时就说，不再等陪同、出行和通知都问完（DEC-031）
...
## 2026-09-14 「照旧」也算答了；同一时刻的冲突不再分医院科室（DEC-030）
...
## 2026-09-14 问医院那句话由 Java 说、也由 Java 认；科室候选一次摆全；助手页卡片收敛（DEC-029）
...
## 2026-09-14 模型链路与规则链路对齐：日期/半天按钮、口语时间补槽、钟点口径共用（DEC-028）
...
## 2026-09-14 助手推荐话术与时段可见性（R7~R9，DEC-027）
...
## 2026-09-14 科室扩至两院各 6 科；每科室 4 位医生、一天 4 格、号源加名额
...
## 2026-09-14 修复 `submit` 的会话级幂等：同一段会话换个时段不再被旧预约顶掉
...
## 2026-09-14 号源聚合落点＋下午专家号第二道闸门＋照护端号源带医生
...
## 2026-09-13 排班重做：每科室固定 3 个放号日 + 半天制，全院 18 位医生
...
## 2026-09-13 医生与号别数据模型（阶段 1：只做数据与展示，不动交互）
...
## 2026-09-13 老人端取消入口：首页同步、垃圾桶直连、两条路并存
